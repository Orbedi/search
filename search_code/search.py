...
def coste_acumulado(GPSproblem):
    cost = Coste()
    result = graph_search(GPSproblem, cost)
    print cost.num
    return result
...
def estimacion_heuristica(GPSproblem):
    h = Heuristica(GPSproblem)
    result = graph_search(GPSproblem, h)
    print h.num
    return result
